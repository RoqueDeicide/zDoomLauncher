...
namespace Launcher.Extensions
{
	...
	public static class PathUtils
	{
		...
		/// <returns>If <paramref name="folderPath"/> ends with a backslash, then it gets returned as is, otherwise a new string that represents <paramref name="folderPath"/> with an appended backslash is returned.</returns>
