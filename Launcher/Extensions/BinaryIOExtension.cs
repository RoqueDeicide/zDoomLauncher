...
namespace Launcher
{
	...
	public static class BinaryIoExtension
	{
		...
		/// </summary>
		/// <remarks>
		/// This method writes 64-bit signed integer that represents a number of bytes that represent the text. Text encoded
		/// in given encoding is written write after the number.
		/// </remarks>
