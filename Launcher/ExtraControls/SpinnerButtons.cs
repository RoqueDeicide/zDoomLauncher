...
namespace Launcher
{
	...
	public class SpinnerButtons : Control
	{
		...
		public static readonly DependencyProperty HighlightedBrushProperty =
			DependencyProperty.Register(nameof(HighlightedBrush), typeof(Brush), typeof(SpinnerButtons),
		...
		public static readonly DependencyProperty PressedBrushProperty =
			DependencyProperty.Register(nameof(PressedBrush), typeof(Brush), typeof(SpinnerButtons),
										new FrameworkPropertyMetadata(default(Brush), FrameworkPropertyMetadataOptions.AffectsRender));
		...
		public static readonly DependencyProperty DisabledBrushProperty =
			DependencyProperty.Register(nameof(DisabledBrush), typeof(Brush), typeof(SpinnerButtons),
										new FrameworkPropertyMetadata(default(Brush), FrameworkPropertyMetadataOptions.AffectsRender));
		...
		public static readonly DependencyProperty AtBottomProperty =
			DependencyProperty.Register(nameof(AtBottom), typeof(bool), typeof(SpinnerButtons), new PropertyMetadata(default(bool)));
		...
		public static readonly DependencyProperty AtTopProperty =
			DependencyProperty.Register(nameof(AtTop), typeof(bool), typeof(SpinnerButtons), new PropertyMetadata(default(bool)));
