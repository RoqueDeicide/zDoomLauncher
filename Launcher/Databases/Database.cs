...
namespace Launcher.Databases
{
	...
	{
		/// <summary>
		/// <see cref="Int32"/> instance that indicates beginning of group of subentries in binary
		/// representation of database entry.
		/// </summary>
		public static readonly int SubEntriesStartMarker = 132383;
		/// <summary>
		/// <see cref="Int32"/> instance that indicates end of group of subentries in binary representation
		/// of database entry.
		/// </summary>
		public static readonly int SubEntriesEndMarker = 172383;
		/// <summary>
		/// <see cref="Int32"/> instance that indicates beginning of database entry in binary
		/// representation of database entry.
		/// </summary>
		public static readonly int EntryStartMarker = 1731;
		/// <summary>
		/// <see cref="Int32"/> instance that indicates the end of database entry in binary representation
		/// of it.
		/// </summary>
		public static readonly int EntryEndMarker = 1731;
		/// <summary>
		/// <see cref="Int32"/> instance that indicates that database entry has a content.
		/// </summary>
		public static readonly int EntryContentPresentMarker = 00001;
		/// <summary>
		/// <see cref="Int32"/> instance that indicates that database entry has no content.
		/// </summary>
		public static readonly int EntryContentAbsentMarker = 11001;
		/// <summary>
		/// <see cref="Int32"/> instance that indicates that current file contains database in binary
		/// format.
		/// </summary>
		public static readonly int BinaryDatabaseFileIdentifier = 4323;
		/// <summary>
		/// <see cref="Int32"/> instance that indicates the end of binary file that stores database.
		/// </summary>
		public static readonly int BinaryDatabaseFileEndMarker = 2959;
		/// <summary>
		/// Gets the list of attributes that designate registered classes derived from
		/// <see cref="DatabaseEntryContent"/>.
		/// </summary>
	...
	public class Database : IEnumerable<string>, IEnumerable<DatabaseEntry>
	{
		...
		{
			get { return this.TopLevelEntries[name]; }
		...
		/// </param>
		/// <param name="searchLowerLevels">Indicates whether to search in subentries.</param>
		/// <returns>
		/// True, if this database contains an entry with specified name, otherwise returns false.
		/// </returns>
	...
	public class DatabaseEntry
	{
		...
		/// <returns>
		/// Content of this entry if <typeparamref name="T"/> matches the type of content of this entry.
		/// Otherwise returns default value of <typeparamref name="T"/>.
		/// </returns>
		...
		/// <summary>
		/// Determines whether this entry contains a subentry with specified name.
		/// </summary>
		/// <param name="name">
		/// Name of the subentry which presence in this entry needs to be determined.
		/// </param>
		/// <returns>
		/// True, if this entry contains a subentry with specified name, otherwise returns false.
		/// </returns>
		...
		/// </summary>
		/// <param name="bw">
		/// <see cref="BinaryWriter"/> object that provides access to binary stream to which binary
		/// representation of this entry is written to.
		/// </param>
		...
		/// </summary>
		/// <param name="br">
		/// <see cref="BinaryReader"/> object that provides access to binary stream which contains binary
		/// representation of database entry.
		/// </param>
		...
		/// </summary>
		/// <param name="element">
		/// <see cref="XmlElement"/> object that provides access to Xml representation of this
		/// <see cref="DatabaseEntry"/> object.
		/// </param>
		/// <exception cref="MemberAccessException">
		/// The class is abstract.-or- The constructor is a class initializer.
		/// </exception>
		...
		public void FromXml(XmlElement element)
		{
			...
			{
				XmlElement item = element.ChildNodes[i] as XmlElement;
				if (item != null)
				{
					children.Add(item);
				}
	...
	public abstract class DatabaseEntryContent
	{
		...
		/// </summary>
		/// <param name="bw">
		/// <see cref="BinaryWriter"/> object that provides access to binary stream
		/// </param>
		...
		/// </summary>
		/// <param name="br">
		/// <see cref="BinaryReader"/> object that provides access to binary stream.
		/// </param>
		...
		/// <param name="element">
		/// <see cref="XmlElement"/> object that provides access to Xml representation of this
		/// <see cref="DatabaseEntryContent"/> object.
		/// </param>
	...
	public sealed class EntryContentAttribute : Attribute
	{
		...
		/// Unable to register database entry content type with name that has the same hash value as one of
		/// the existing ones.
		/// </exception>
