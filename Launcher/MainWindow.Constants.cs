...
namespace Launcher
{
	public partial class MainWindow
	{
		...
		// Name of the application configuration entry that contains the path to the folder were Doom
		// source port files are located.
		private const string GameFolderEntryName = "zDoomInstallationFolder";
		// Name of the application configuration entry that contains the full name of the file that
		// contains last used launch configuration.
